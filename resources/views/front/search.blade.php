    ...
    <div class="page_content">
        ...
        <div class="tf-page-title">
            <div class="container-full">
                <div class="heading text-center"> البحث </div>
                <p class="text-center text-2 text_black-2 mt_5"> نتائج البحث </p>
            </div>
        </div>
        <!-- /page-title -->
        ...
        <section class="flat-spacing-2">
            <div class="container">
                ...
                @else
                <div class="not_products_search text-center">
                    <p class="" style="font-size:20px;margin-bottom:15px"> لم يتم العثور علي منتجات بهذا الاسم  </p>
                    <a style="background: #000;border-color: #000;width: 120px;" href="{{ url('/') }}" class="btn btn-primary head_read_more"> الرئيسية <i style="position: relative;top: 2px;" class="bi bi-arrow-left"></i> </a>
                </div>
