            ...
            <form action="{{url('admin/top-navbar/update/'.$nav['id'])}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="text_color" class="form-control form-control-color" value="{{$nav['text_color'] ?? '#ffffff'}}" style="width: 100%">
                    </div>
                    <div class="mb-3">
                        <label for=""> لون خلفية الزر </label>
                        <input type="color" name="button_background" class="form-control form-control-color" value="{{$nav['button_background'] ?? '#000000'}}" style="width: 100%">
                    </div>
                    <div class="mb-3">
                        <label for=""> لون نص الزر </label>
                        <input type="color" name="button_color" class="form-control form-control-color" value="{{$nav['button_color'] ?? '#ffffff'}}" style="width: 100%">
                    </div>
                </div>
