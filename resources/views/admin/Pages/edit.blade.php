                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">تعديل الصفحة: {{ $page->title }}</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $page->slug) }}" placeholder="سيتم إنشاؤه تلقائياً إذا ترك فارغاً">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="show_in_footer" name="show_in_footer" value="1" {{ old('show_in_footer', $page->show_in_footer) ? 'checked' : '' }}>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">معلومات الصفحة</label>
                                                    <div class="small text-muted">
                                                        <p><strong>معرف:</strong> {{ $page->id }}</p>
                                                        <p><strong>تاريخ الإنشاء:</strong> {{ $page->created_at->format('Y-m-d H:i') }}</p>
                                                        <p><strong>آخر تعديل:</strong> {{ $page->updated_at->format('Y-m-d H:i') }}</p>
                                                        @if($page->slug)
                                                            <p><strong>الرابط:</strong> <code>/page/{{ $page->slug }}</code></p>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
