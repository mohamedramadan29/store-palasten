                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="website_background"
                                            class="form-control form-control-color" name="website_background"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="top_navbar_background" class="form-label"> خلفية الشريط الاعلاني
                                    </label>
                                    <div class="input-group">
                                        <input type="color" id="top_navbar_background"
                                            class="form-control form-control-color" name="top_navbar_background"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="second_navbar_background"
                                            class="form-control form-control-color" name="second_navbar_background"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="third_navbar_background"
                                            class="form-control form-control-color" name="third_navbar_background"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="search_category_background" class="form-label"> خلفية تصنيفات البحث
                                    </label>
                                    <div class="input-group">
                                        <input type="color" id="search_category_background"
                                            class="form-control form-control-color" name="search_category_background"
                                            value="#{{ ltrim($colors['search_category_background'] ?? '#ffffff', '#') }}">
                                        <input type="text" class="form-control hex-input"
                                            value="#{{ strtoupper(ltrim($colors['search_category_background'] ?? '#ffffff', '#')) }}"
                                            data-target="search_category_background" style="max-width: 110px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="search_background" class="form-label"> خلفية شريط البحث </label>
                                    <div class="input-group">
                                        <input type="color" id="search_background" class="form-control form-control-color"
                                            name="search_background" value="#{{ ltrim($colors['search_background'] ?? '#ffffff', '#') }}">
                                        <input type="text" class="form-control hex-input"
                                            value="#{{ strtoupper(ltrim($colors['search_background'] ?? '#ffffff', '#')) }}"
                                            data-target="search_background" style="max-width: 110px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="search_icon_background" class="form-label"> خلفية ايقونة البحث </label>
                                    <div class="input-group">
                                        <input type="color" id="search_icon_background"
                                            class="form-control form-control-color" name="search_icon_background"
                                            value="#{{ ltrim($colors['search_icon_background'] ?? '#ffffff', '#') }}">
                                        <input type="text" class="form-control hex-input"
                                            value="#{{ strtoupper(ltrim($colors['search_icon_background'] ?? '#ffffff', '#')) }}"
                                            data-target="search_icon_background" style="max-width: 110px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="search_icon_color" class="form-label"> لون ايقونة البحث </label>
                                    <div class="input-group">
                                        <input type="color" id="search_icon_color" class="form-control form-control-color"
                                            name="search_icon_color" value="#{{ ltrim($colors['search_icon_color'] ?? '#ffffff', '#') }}">
                                        <input type="text" class="form-control hex-input"
                                            value="#{{ strtoupper(ltrim($colors['search_icon_color'] ?? '#ffffff', '#')) }}"
                                            data-target="search_icon_color" style="max-width: 110px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="main_title_color"
                                            class="form-control form-control-color" name="main_title_color"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="product_title_color" class="form-label"> لون عناوين المنتجات </label>
                                    <div class="input-group">
                                        <input type="color" id="product_title_color"
                                            class="form-control form-control-color" name="product_title_color"
                                            value="#{{ ltrim($colors['product_title_color'] ?? '#000000', '#') }}">
                                        <input type="text" class="form-control hex-input"
                                            value="#{{ strtoupper(ltrim($colors['product_title_color'] ?? '#000000', '#')) }}"
                                            data-target="product_title_color" style="max-width: 110px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="all_button_background"
                                            class="form-control form-control-color" name="all_button_background"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="main_price_color"
                                            class="form-control form-control-color" name="main_price_color"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="public_add_to_cart_background" class="form-label"> لون خلفية زر اضف الي
                                        السلة </label>
                                    <div class="input-group">
                                        <input type="color" id="public_add_to_cart_background"
                                            class="form-control form-control-color" name="public_add_to_cart_background"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    <label for="public_add_to_cart_color" class="form-label"> لون نص زر اضف الي السلة
                                    </label>
                                    <div class="input-group">
                                        <input type="color" id="public_add_to_cart_color"
                                            class="form-control form-control-color" name="public_add_to_cart_color"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="footer_background"
                                            class="form-control form-control-color" name="footer_background"
