...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('colors', function (Blueprint $table) {
            ...
            $table->string('product_title_color')->nullable();
            $table->string('search_category_background')->nullable();
            $table->string('search_background')->nullable();
            $table->string('search_icon_background')->nullable();
            $table->string('search_icon_color')->nullable();
            $table->timestamps();
        });
    }
